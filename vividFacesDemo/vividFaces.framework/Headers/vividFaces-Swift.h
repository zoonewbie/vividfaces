...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vividFaces",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10vividFaces14GameController")
...
@interface GameController (SWIFT_EXTENSION(vividFaces)) <AVCaptureVideoDataOutputSampleBufferDelegate, AVPlayerViewControllerDelegate>
...
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sb fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end
...
SWIFT_CLASS("_TtC10vividFaces11VFAnimation")
@interface VFAnimation : CABasicAnimation
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10vividFaces16VFAnimationGroup")
@interface VFAnimationGroup : CAAnimationGroup
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
