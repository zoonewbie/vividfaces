...
void InitDefaultsObliviousSplitInfoImpl();
void InitDefaultsObliviousSplitInfo();
inline void InitDefaults() {
  InitDefaultsSplitInfo();
  InitDefaultsObliviousSplitInfo();
}
}  // namespace protobuf_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fsplit_5finfo_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::boosted_trees::learner::ObliviousSplitInfo* Arena::CreateMessage< ::tensorflow::boosted_trees::learner::ObliviousSplitInfo>(Arena*);
...
class ObliviousSplitInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.ObliviousSplitInfo) */ {
 public:
  ...
  inline ObliviousSplitInfo* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<ObliviousSplitInfo>(NULL);
  }

  ObliviousSplitInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<ObliviousSplitInfo>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fsplit_5finfo_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fsplit_5finfo_2eproto::InitDefaultsObliviousSplitInfoImpl();
};
// ===================================================================
