...
void InitDefaultsObliviousSplitInfo() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsObliviousSplitInfoImpl);
}
...
ObliviousSplitInfo::ObliviousSplitInfo()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fsplit_5finfo_2eproto::InitDefaultsObliviousSplitInfo();
  }
  SharedCtor();
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::boosted_trees::learner::ObliviousSplitInfo* Arena::CreateMessage< ::tensorflow::boosted_trees::learner::ObliviousSplitInfo >(Arena* arena) {
