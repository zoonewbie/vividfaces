...
template<> ::tensorflow::KernelList* Arena::CreateMessage< ::tensorflow::KernelList>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class KernelList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelList) */ {
 public:
  ...
  inline KernelList* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<KernelList>(NULL);
  }

  KernelList* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fkernel_5fdef_2eproto::InitDefaultsKernelListImpl();
};
// ===================================================================
