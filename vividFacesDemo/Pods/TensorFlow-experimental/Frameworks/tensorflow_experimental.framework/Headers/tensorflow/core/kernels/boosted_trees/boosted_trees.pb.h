...
template<> ::tensorflow::boosted_trees::DebugOutput* Arena::CreateMessage< ::tensorflow::boosted_trees::DebugOutput>(Arena*);
...
class DebugOutput : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.DebugOutput) */ {
 public:
  ...
  inline DebugOutput* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<DebugOutput>(NULL);
  }
