...
::google::protobuf::uint8* WorkerHeartbeatRequest::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_watchdog_config()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *watchdog_config_, deterministic, target);
  }
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::WatchdogConfig* Arena::CreateMessage< ::tensorflow::WatchdogConfig >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::WatchdogConfig >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::WorkerHeartbeatRequest* Arena::CreateMessage< ::tensorflow::WorkerHeartbeatRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::WorkerHeartbeatRequest >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::WorkerHeartbeatResponse* Arena::CreateMessage< ::tensorflow::WorkerHeartbeatResponse >(Arena* arena) {
