...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestField* Arena::Create< ::protobuf_unittest::TestField >(Arena* arena) {
  return Arena::CreateInternal< ::protobuf_unittest::TestField >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestDiffMessage_Item* Arena::Create< ::protobuf_unittest::TestDiffMessage_Item >(Arena* arena) {
  return Arena::CreateInternal< ::protobuf_unittest::TestDiffMessage_Item >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestDiffMessage* Arena::Create< ::protobuf_unittest::TestDiffMessage >(Arena* arena) {
