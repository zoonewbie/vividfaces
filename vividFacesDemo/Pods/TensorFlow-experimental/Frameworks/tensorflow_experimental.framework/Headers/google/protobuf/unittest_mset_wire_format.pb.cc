...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_wireformat_unittest::TestMessageSet* Arena::CreateMessage< ::proto2_wireformat_unittest::TestMessageSet >(Arena* arena) {
  return Arena::CreateMessageInternal< ::proto2_wireformat_unittest::TestMessageSet >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_wireformat_unittest::TestMessageSetWireFormatContainer* Arena::CreateMessage< ::proto2_wireformat_unittest::TestMessageSetWireFormatContainer >(Arena* arena) {
