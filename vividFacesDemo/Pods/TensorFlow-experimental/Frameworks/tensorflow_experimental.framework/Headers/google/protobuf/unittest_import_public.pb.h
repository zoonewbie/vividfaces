...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest_import::PublicImportMessage* Arena::Create< ::protobuf_unittest_import::PublicImportMessage>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest_import {
...
class PublicImportMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest_import.PublicImportMessage) */ {
 public:
  ...
  inline PublicImportMessage* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<PublicImportMessage>(NULL);
  }

  PublicImportMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<PublicImportMessage>(arena);
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_2eproto_INCLUDED
