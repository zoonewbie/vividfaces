...
#ifndef PROTOBUF_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest::TestLargeEnumValue* Arena::Create< ::protobuf_unittest::TestLargeEnumValue>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest {
...
class TestLargeEnumValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestLargeEnumValue) */ {
 public:
  ...
  inline TestLargeEnumValue* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestLargeEnumValue>(NULL);
  }

  TestLargeEnumValue* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestLargeEnumValue>(arena);
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto_INCLUDED
