...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestOptimizedForSize* Arena::Create< ::protobuf_unittest::TestOptimizedForSize >(Arena* arena) {
  return Arena::CreateInternal< ::protobuf_unittest::TestOptimizedForSize >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestRequiredOptimizedForSize* Arena::Create< ::protobuf_unittest::TestRequiredOptimizedForSize >(Arena* arena) {
  return Arena::CreateInternal< ::protobuf_unittest::TestRequiredOptimizedForSize >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestOptionalOptimizedForSize* Arena::Create< ::protobuf_unittest::TestOptionalOptimizedForSize >(Arena* arena) {
