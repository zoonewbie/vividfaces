...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest_import::PublicImportMessageLite* Arena::Create< ::protobuf_unittest_import::PublicImportMessageLite>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest_import {
...
class PublicImportMessageLite : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:protobuf_unittest_import.PublicImportMessageLite) */ {
 public:
  ...
  inline PublicImportMessageLite* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<PublicImportMessageLite>(NULL);
  }

  PublicImportMessageLite* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<PublicImportMessageLite>(arena);
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fimport_5fpublic_5flite_2eproto_INCLUDED
