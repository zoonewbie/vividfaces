...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest_no_arena::ForeignMessageLite* Arena::Create< ::protobuf_unittest_no_arena::ForeignMessageLite >(Arena* arena) {
