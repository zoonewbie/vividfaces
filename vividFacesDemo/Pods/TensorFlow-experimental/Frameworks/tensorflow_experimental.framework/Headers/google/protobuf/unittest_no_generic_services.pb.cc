...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::protobuf::no_generic_services_test::TestMessage* Arena::Create< ::google::protobuf::no_generic_services_test::TestMessage >(Arena* arena) {
