...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fdrop_5funknown_5ffields_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fdrop_5funknown_5ffields_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::unittest_drop_unknown_fields::Foo* Arena::Create< ::unittest_drop_unknown_fields::Foo>(Arena*);
template<> ::unittest_drop_unknown_fields::FooWithExtraFields* Arena::Create< ::unittest_drop_unknown_fields::FooWithExtraFields>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace unittest_drop_unknown_fields {
...
class Foo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:unittest_drop_unknown_fields.Foo) */ {
 public:
  ...
  inline Foo* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Foo>(NULL);
  }

  Foo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Foo>(arena);
  }
...
class FooWithExtraFields : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:unittest_drop_unknown_fields.FooWithExtraFields) */ {
 public:
  ...
  inline FooWithExtraFields* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<FooWithExtraFields>(NULL);
  }

  FooWithExtraFields* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<FooWithExtraFields>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fdrop_5funknown_5ffields_2eproto_INCLUDED
