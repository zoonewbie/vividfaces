  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *optional_message_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestEmbedOptimizedForSize* Arena::Create< ::protobuf_unittest::TestEmbedOptimizedForSize >(Arena* arena) {
