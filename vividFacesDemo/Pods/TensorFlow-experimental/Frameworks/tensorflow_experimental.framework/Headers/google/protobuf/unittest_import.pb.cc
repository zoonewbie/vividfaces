...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest_import::ImportMessage* Arena::CreateMessage< ::protobuf_unittest_import::ImportMessage >(Arena* arena) {
