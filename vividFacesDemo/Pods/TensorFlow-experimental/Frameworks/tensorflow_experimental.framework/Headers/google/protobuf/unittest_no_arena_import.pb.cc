...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_arena_unittest::ImportNoArenaNestedMessage* Arena::Create< ::proto2_arena_unittest::ImportNoArenaNestedMessage >(Arena* arena) {
