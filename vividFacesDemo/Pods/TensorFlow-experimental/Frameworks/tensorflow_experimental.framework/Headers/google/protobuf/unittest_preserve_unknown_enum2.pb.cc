...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_preserve_unknown_enum_unittest::MyMessage* Arena::Create< ::proto2_preserve_unknown_enum_unittest::MyMessage >(Arena* arena) {
