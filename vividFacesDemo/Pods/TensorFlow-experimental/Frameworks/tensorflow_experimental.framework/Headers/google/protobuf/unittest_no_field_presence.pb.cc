...
void TestAllTypes::SerializeWithCachedSizes(
  ...
  if (this->has_optional_proto2_message()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      20, *optional_proto2_message_, output);
  }
  ...
  if (this->has_optional_lazy_message()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      30, *optional_lazy_message_, output);
  }
...
::google::protobuf::uint8* TestAllTypes::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_optional_proto2_message()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        20, *optional_proto2_message_, deterministic, target);
  }
  ...
  if (this->has_optional_lazy_message()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        30, *optional_lazy_message_, deterministic, target);
  }
...
::google::protobuf::uint8* TestProto2Required::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_proto2()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *proto2_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >(Arena* arena) {
  return Arena::CreateInternal< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_nofieldpresence_unittest::TestAllTypes* Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes >(Arena* arena) {
  return Arena::CreateInternal< ::proto2_nofieldpresence_unittest::TestAllTypes >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_nofieldpresence_unittest::TestProto2Required* Arena::Create< ::proto2_nofieldpresence_unittest::TestProto2Required >(Arena* arena) {
  return Arena::CreateInternal< ::proto2_nofieldpresence_unittest::TestProto2Required >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_nofieldpresence_unittest::ForeignMessage* Arena::Create< ::proto2_nofieldpresence_unittest::ForeignMessage >(Arena* arena) {
