...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::unittest_drop_unknown_fields::Foo* Arena::Create< ::unittest_drop_unknown_fields::Foo >(Arena* arena) {
  return Arena::CreateInternal< ::unittest_drop_unknown_fields::Foo >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::unittest_drop_unknown_fields::FooWithExtraFields* Arena::Create< ::unittest_drop_unknown_fields::FooWithExtraFields >(Arena* arena) {
