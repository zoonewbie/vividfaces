...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::lazy_imports::LazyMessage* Arena::CreateMessage< ::protobuf_unittest::lazy_imports::LazyMessage >(Arena* arena) {
