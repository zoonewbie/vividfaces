...
#ifndef PROTOBUF_google_2fprotobuf_2futil_2fmessage_5fdifferencer_5funittest_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2futil_2fmessage_5fdifferencer_5funittest_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest::TestDiffMessage* Arena::Create< ::protobuf_unittest::TestDiffMessage>(Arena*);
template<> ::protobuf_unittest::TestDiffMessage_Item* Arena::Create< ::protobuf_unittest::TestDiffMessage_Item>(Arena*);
template<> ::protobuf_unittest::TestField* Arena::Create< ::protobuf_unittest::TestField>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest {
...
class TestField : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestField) */ {
 public:
  ...
  inline TestField* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestField>(NULL);
  }

  TestField* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestField>(arena);
  }
...
class TestDiffMessage_Item : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestDiffMessage.Item) */ {
 public:
  ...
  inline TestDiffMessage_Item* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestDiffMessage_Item>(NULL);
  }

  TestDiffMessage_Item* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestDiffMessage_Item>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class TestDiffMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestDiffMessage) */ {
 public:
  ...
  inline TestDiffMessage* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestDiffMessage>(NULL);
  }

  TestDiffMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestDiffMessage>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline ::protobuf_unittest::TestField* TestField::mutable_m() {
  set_has_m();
  if (m_ == NULL) {
    m_ = ::google::protobuf::Arena::Create< ::protobuf_unittest::TestField >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2futil_2fmessage_5fdifferencer_5funittest_2eproto_INCLUDED
