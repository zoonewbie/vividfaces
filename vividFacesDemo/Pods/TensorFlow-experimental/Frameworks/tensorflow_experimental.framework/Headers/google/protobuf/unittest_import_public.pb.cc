...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest_import::PublicImportMessage* Arena::Create< ::protobuf_unittest_import::PublicImportMessage >(Arena* arena) {
