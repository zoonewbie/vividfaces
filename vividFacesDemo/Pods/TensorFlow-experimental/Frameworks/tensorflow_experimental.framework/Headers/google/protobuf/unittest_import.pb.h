...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fimport_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fimport_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest_import::ImportMessage* Arena::CreateMessage< ::protobuf_unittest_import::ImportMessage>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest_import {
...
class ImportMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest_import.ImportMessage) */ {
 public:
  ...
  inline ImportMessage* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<ImportMessage>(NULL);
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fimport_2eproto_INCLUDED
