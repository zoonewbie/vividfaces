...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::proto2_nofieldpresence_unittest::ForeignMessage* Arena::Create< ::proto2_nofieldpresence_unittest::ForeignMessage>(Arena*);
template<> ::proto2_nofieldpresence_unittest::TestAllTypes* Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes>(Arena*);
template<> ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage>(Arena*);
template<> ::proto2_nofieldpresence_unittest::TestProto2Required* Arena::Create< ::proto2_nofieldpresence_unittest::TestProto2Required>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace proto2_nofieldpresence_unittest {
...
class TestProto2Required : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto2_nofieldpresence_unittest.TestProto2Required) */ {
 public:
  ...
  inline TestProto2Required* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestProto2Required>(NULL);
  }

  TestProto2Required* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestProto2Required>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* TestAllTypes::mutable_optional_nested_message() {
  ...
  if (optional_nested_message_ == NULL) {
    optional_nested_message_ = ::google::protobuf::Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >(
        GetArenaNoVirtual());
  }
...
inline ::proto2_nofieldpresence_unittest::ForeignMessage* TestAllTypes::mutable_optional_foreign_message() {
  ...
  if (optional_foreign_message_ == NULL) {
    optional_foreign_message_ = ::google::protobuf::Arena::Create< ::proto2_nofieldpresence_unittest::ForeignMessage >(
        GetArenaNoVirtual());
  }
...
inline ::protobuf_unittest::TestAllTypes* TestAllTypes::mutable_optional_proto2_message() {
  ...
  if (optional_proto2_message_ == NULL) {
    optional_proto2_message_ = ::google::protobuf::Arena::CreateMessage< ::protobuf_unittest::TestAllTypes >(
        GetArenaNoVirtual());
  }
...
inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* TestAllTypes::mutable_optional_lazy_message() {
  ...
  if (optional_lazy_message_ == NULL) {
    optional_lazy_message_ = ::google::protobuf::Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >(
        GetArenaNoVirtual());
  }
...
inline ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage* TestAllTypes::mutable_oneof_nested_message() {
  if (!has_oneof_nested_message()) {
    ...
    oneof_field_.oneof_nested_message_ = ::google::protobuf::Arena::Create< ::proto2_nofieldpresence_unittest::TestAllTypes_NestedMessage >(
        GetArenaNoVirtual());
  }
...
inline ::protobuf_unittest::TestRequired* TestProto2Required::mutable_proto2() {
  ...
  if (proto2_ == NULL) {
    proto2_ = ::google::protobuf::Arena::CreateMessage< ::protobuf_unittest::TestRequired >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto_INCLUDED
