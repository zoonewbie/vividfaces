...
#ifndef PROTOBUF_google_2fprotobuf_2fany_5ftest_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2fany_5ftest_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest::TestAny* Arena::Create< ::protobuf_unittest::TestAny>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest {
...
inline ::google::protobuf::Any* TestAny::mutable_any_value() {
  ...
  if (any_value_ == NULL) {
    any_value_ = ::google::protobuf::Arena::Create< ::google::protobuf::Any >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2fany_5ftest_2eproto_INCLUDED
