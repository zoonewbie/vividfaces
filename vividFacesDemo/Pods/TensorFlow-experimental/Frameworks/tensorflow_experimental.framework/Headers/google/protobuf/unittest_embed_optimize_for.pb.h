...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest::TestEmbedOptimizedForSize* Arena::Create< ::protobuf_unittest::TestEmbedOptimizedForSize>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest {
...
class TestEmbedOptimizedForSize : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestEmbedOptimizedForSize) */ {
 public:
  ...
  inline TestEmbedOptimizedForSize* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestEmbedOptimizedForSize>(NULL);
  }

  TestEmbedOptimizedForSize* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestEmbedOptimizedForSize>(arena);
  }
...
inline ::protobuf_unittest::TestOptimizedForSize* TestEmbedOptimizedForSize::mutable_optional_message() {
  ...
  if (optional_message_ == NULL) {
    optional_message_ = ::google::protobuf::Arena::Create< ::protobuf_unittest::TestOptimizedForSize >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5fembed_5foptimize_5ffor_2eproto_INCLUDED
