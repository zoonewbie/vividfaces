...
#ifndef PROTOBUF_google_2fprotobuf_2funittest_5foptimize_5ffor_2eproto_INCLUDED
#define PROTOBUF_google_2fprotobuf_2funittest_5foptimize_5ffor_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::protobuf_unittest::TestOptimizedForSize* Arena::Create< ::protobuf_unittest::TestOptimizedForSize>(Arena*);
template<> ::protobuf_unittest::TestOptionalOptimizedForSize* Arena::Create< ::protobuf_unittest::TestOptionalOptimizedForSize>(Arena*);
template<> ::protobuf_unittest::TestRequiredOptimizedForSize* Arena::Create< ::protobuf_unittest::TestRequiredOptimizedForSize>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace protobuf_unittest {
...
class TestOptimizedForSize : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestOptimizedForSize) */ {
 public:
  ...
  inline TestOptimizedForSize* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestOptimizedForSize>(NULL);
  }

  TestOptimizedForSize* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestOptimizedForSize>(arena);
  }
...
class TestRequiredOptimizedForSize : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestRequiredOptimizedForSize) */ {
 public:
  ...
  inline TestRequiredOptimizedForSize* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestRequiredOptimizedForSize>(NULL);
  }

  TestRequiredOptimizedForSize* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestRequiredOptimizedForSize>(arena);
  }
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
...
class TestOptionalOptimizedForSize : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf_unittest.TestOptionalOptimizedForSize) */ {
 public:
  ...
  inline TestOptionalOptimizedForSize* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestOptionalOptimizedForSize>(NULL);
  }

  TestOptionalOptimizedForSize* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<TestOptionalOptimizedForSize>(arena);
  }
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
...
inline ::protobuf_unittest::ForeignMessage* TestOptimizedForSize::mutable_msg() {
  set_has_msg();
  if (msg_ == NULL) {
    msg_ = ::google::protobuf::Arena::CreateMessage< ::protobuf_unittest::ForeignMessage >(
        GetArenaNoVirtual());
  }
...
inline ::protobuf_unittest::TestRequiredOptimizedForSize* TestOptionalOptimizedForSize::mutable_o() {
  set_has_o();
  if (o_ == NULL) {
    o_ = ::google::protobuf::Arena::Create< ::protobuf_unittest::TestRequiredOptimizedForSize >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_google_2fprotobuf_2funittest_5foptimize_5ffor_2eproto_INCLUDED
